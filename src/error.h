...
typedef enum {
    ...
    ERR_SLOT_WITH_PARENT_IN_SLOT_TABLE = 33,
    ERR_UNIMPLEMENTED_SOUND = 34,
    ERR_MUSIC_CHANNEL_MISMATCH = 35,
    ERR_NON_CONTIGUOUS_LOOP_SAMPLE = 36,
    ERR_INDEX_FILE_NOT_LOADED = 37,
