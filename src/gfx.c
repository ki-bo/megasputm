...
static void print_helpscreen_en(void)
{
  ...
  print_helpscreen_text( 2, y  , "L10n Support:", color2);
  print_helpscreen_text(16, y  , "Bieno", color1);
  y += 2;
...
static void print_helpscreen_de(void)
{
  ...
  print_helpscreen_text( 2, y  , "L10n Helfer:", color2);
  print_helpscreen_text(18, y  , "Bieno", color1);
  y += 2;
...
static void print_helpscreen_es(void)
{
  ...
  print_helpscreen_text(16, y++, "Nico, Robert Hennig (kjubert), Sarah, Thomas Runge (Lefty64)", color1);
  print_helpscreen_text( 2, y  , "Soporte L10n:", color2);
  print_helpscreen_text(16, y  , "Bieno", color1);
  y += 2;
