...
LN_FLAGS_MM    = mega65-mm.scm $(LN_FLAGS) --no-tree-shaking --raw-multiple-memories --cstartup=mm --rtattr exit=simplified --output-format=raw --list-file=mm-mega65.lst
...
mm1.d81: runtime.raw setup.prg $(SAVE_FILES)
	...
	$(C1541) -attach mm1.d81 -write runtime.raw autoboot.c65 setup.prg setup -write script.raw m01 -write main.raw m02 -write m0-3.raw m03 -write m1-0.raw m10 -write m1-2.raw m12 -write m1-3.raw m13 -write mc-0.raw mc0; \
