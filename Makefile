...
LN_FLAGS  = --target=mega65 mega65-mm.scm --verbose --raw-multiple-memories --cstartup=mm --rtattr initialize=large --rtattr exit=simplified --rtattr printf=nofloat --output-format=raw --list-file=mm-mega65.lst
